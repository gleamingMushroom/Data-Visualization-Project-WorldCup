...
This Project is visualization data product inspired by an article of Vox -- [America's unique gun violence problem, explained in 17 maps and charts](https://www.vox.com/policy-and-politics/2017/10/2/16399418/us-gun-violence-statistics-maps-charts). 
...
[Tableau Public Link](https://us-west-2b.online.tableau.com/#/site/yezhuli/views/revisedversion/map-revised?:iid=1)
...
In order to see these trend clearly, first version was trying to recreate a calendar and showing the rising trend by bar chart, but it's actually not intuitive to audience. In the revised version, using the incidents happened in 2018 as timeline graph and data from 2014 to 2017 indicates the trend, it's obvious that this situation are not getting better year after year, and surprisingly, for each year, Q3 always reached the peak of the year.
...
[Tableau Public Link 1](https://us-west-2b.online.tableau.com/#/site/yezhuli/views/revisedversion/MS2018?:iid=5)
[Tableau Public Link 2](https://us-west-2b.online.tableau.com/#/site/yezhuli/views/revisedversion/MSTrend?:iid=4)
...
[Tableau Public Link](https://us-west-2b.online.tableau.com/#/site/yezhuli/views/revisedversion/GunLawvsGunDeath?:iid=6)
...
Revised Version Graph |
------------- |
![](https://github.com/gleamingMushroom/AddImage/blob/master/F4%20-%20homicide.png) |
